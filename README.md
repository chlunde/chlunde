...
- [tjdevries/educationalsp](https://github.com/tjdevries/educationalsp) -  (83 stargazers)
...
- [uber-go/nilaway](https://github.com/uber-go/nilaway) - Static Analysis tool to detect potential Nil panics in Go code (2650 stargazers)
