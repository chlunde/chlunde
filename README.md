...
- [go-logr/logr](https://github.com/go-logr/logr) - A simple logging interface for Go (809 stargazers)
...
- [gcla/termshark](https://github.com/gcla/termshark) - A terminal UI for tshark, inspired by Wireshark (7474 stargazers)
