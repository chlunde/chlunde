...
- [chlunde/xp-state-metrics](https://github.com/chlunde/xp-state-metrics) - POC/WIP (3 days ago)
...
- [upbound/provider-aws](https://github.com/upbound/provider-aws) - Official AWS Provider for Crossplane by Upbound. (10 stargazers)
